...
// Component showing a brief description of the project
const Description = () => {
  return (
    <div className="text-white bg-transparent text-sm md:text-2xl max-w-5xl text-center selection:tracking-wide">
      <HeroHighlight>
        ...
        >
          ...
          utilizes <Highlight className="text-white">Redis, Socket.io, PostgreSQL, and AWS S3</Highlight> technologies. The languages used are <Highlight className="text-white">Next.js and Go (Golang).</Highlight>
        </motion.h1>
      </HeroHighlight>
    </div>
  );
