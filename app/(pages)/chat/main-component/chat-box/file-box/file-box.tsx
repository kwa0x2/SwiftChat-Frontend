...
const FileBox: React.FC<FileBoxProps> = ({ setSelectedFile, selectedFile }) => {
  return (
    <div>
      {selectedFile && (
        <div className="backdrop-blur-md  sm:w-[25%] 2xl:w-[14%]  flex flex-col text-white/70 justify-center items-center align-middle h-[300px] rounded-e-md relative z-10 bg-transparent">
          <X
